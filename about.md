...
<!-- Fixed Image on Right (visible on desktop) -->
...
<!-- Scrollable Content on Left -->
<div class="about-scrollable-content">
    <!-- Hero Section -->
    <div class="about-hero">
        <h1>{{ site.data.about.hero.title }}</h1>
        <p class="hero-tagline">{{ site.data.about.hero.tagline }}</p>
        ...
        <div class="story-section leadership-section">
            ...
            <div class="section-content">
                ...
                <div class="blog-reference">
                    <p>{{ site.data.about.leadership.blog_reference }}</p>
                </div>
                {% endif %}
            </div>
        </div>
